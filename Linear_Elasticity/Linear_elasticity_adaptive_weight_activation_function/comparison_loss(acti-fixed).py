...
def Plot_loss():
    loss_adaptive = np.load('./result_data/training_loss(8000)_(Weighted_Average).npy')
    ...
    plt.plot(loss_L1norm, label='PINN with L1norm',
             color='lightcoral', linestyle='-', lw=1.2,zorder=3)
    plt.plot(loss_L2norm, label='PINN with L2norm',
             color='darkorchid', linestyle='-', lw=1.2,zorder=5)
    plt.plot(loss_adaptive,label='PINN with Weight Average',
             color='forestgreen',linestyle='-',lw=1.2,zorder=5)
